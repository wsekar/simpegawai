                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="{{asset/iassets/mages/dashboard/people.svg" alt="people}}"/>
                                    ...
                                    <div class="list-wrapper pt-2">
                                        <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                                            ...
                                            <li class="completed">
                                                <div class="form-check form-check-flat">
                                                    <label class="form-check-label">
                                                        <input class="checkbox" type="checkbox" checke}}d/>
                                            ...
                                            <li>
                                                <div class="form-check form-check-flat">
                                                    <label class="form-check-label">
                                                        <input class="checkbox" type="checkbox}}"/> Level
                                                        up for Antony
                                                    </label>
                                                </div>
                                                <i class="remove ti-close"></i>
                                        ...
                                        <table class="table table-borderless">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">65</span>(2.15%)
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">54</span>(3.25%)
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">22</span>(2.22%)
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">46</span>(3.27%)
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">17</span>(1.25%)
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">52</span>(3.11%)
                                                        </p>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pb-0">
                                                        <p class="mb-0">
                                                            <span class="font-weight-bold me-2">25</span>(1.32%)
                                                        </p>
                                                    </td>
                                                    <td class="pb-0">14</td>
                                                </tr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="icon-data-list">
                                        <li>
                                            <div class="d-flex">
                                                <img src="{{asset/iassets/mages/faces/face1.jpg" alt="user}}"/>
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="{{asset/iassets/mages/faces/face2.jpg" alt="user}}"/>
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="{{asset/iassets/mages/faces/face3.jpg" alt="user}}"/>
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="{{asset/iassets/mages/faces/face4.jpg" alt="user}}"/>
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="{{asset/iassets/mages/faces/face5.jpg" alt="user}}"/>
                                                <div>
