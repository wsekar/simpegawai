                      ...
                      <table class="table table-borderless">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">65</span
                                >(2.15%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">54</span
                                >(3.25%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">22</span
                                >(2.22%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">46</span
                                >(3.27%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">17</span
                                >(1.25%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">52</span
                                >(3.11%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="pb-0">
                              <p class="mb-0">
                                <span class="font-weight-bold me-2">25</span
                                >(1.32%)
                              </p>
                            </td>
                            <td class="pb-0">14</td>
                      ...
                      <div class="card-body">
                        ...
                        <div class="charts-data">
                          <div class="mt-3">
                            ...
                            >
                              <div
                                class="progress progress-md flex-grow-1 me-4"
                              >
                                <div
...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <p class="card-title mb-0">Pegawai yang Mendekati Pensiun</p>
                    <div class="table-responsive">
                        <table class="table table-striped table-borderless">
                            <thead>
                                <tr>
